...
func (inst *SetLoadedAccountsDataSizeLimit) SetAccountDataSizeLimit(limit uint32) *SetLoadedAccountsDataSizeLimit {
	inst.AccountDataSizeLimit = limit
	return inst
}
...
func (inst *SetLoadedAccountsDataSizeLimit) Validate() error {
	...
	{
		if inst.AccountDataSizeLimit == 0 {
			return errors.New("AccountDataSizeLimit parameter is not set")
		}
	}
	return nil
}
			...
			programBranch.Child(ag_format.Instruction("SetLoadedAccountsDataSizeLimit")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						paramsBranch.Child(ag_format.Param("AccountDataSizeLimit", inst.AccountDataSizeLimit))
					})
				})
		})
}
...
func (obj SetLoadedAccountsDataSizeLimit) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `AccountDataSizeLimit` param:
	err = encoder.Encode(obj.AccountDataSizeLimit)
	if err != nil {
		return err
	}
	return nil
...
func (obj *SetLoadedAccountsDataSizeLimit) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `AccountDataSizeLimit`:
	err = decoder.Decode(&obj.AccountDataSizeLimit)
	if err != nil {
		return err
	}
	return nil
...
func NewSetLoadedAccountsDataSizeLimitInstruction(
	...
	return NewSetLoadedAccountsDataSizeLimitInstructionBuilder().SetAccountDataSizeLimit(accountDataSizeLimit)
}